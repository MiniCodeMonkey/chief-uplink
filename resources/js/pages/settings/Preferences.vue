                        ...
                        >
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Select your preferred theme. System follows
                                    your OS preference.
                                </p>
                            </div>
                            <AppearanceTabs />
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Get notified in your browser when runs
                        ...
                        >
                            <div class="space-y-1">
                                ...
                                <p class="text-sm text-muted-foreground">
                                    Receive email digests when runs complete,
                                    fail, or when servers go offline
                                </p>
                            </div>
                            <div>
                                <Toggle
                        ...
                        >
                            ...
                            <p class="mt-1 text-sm text-muted-foreground">
                                Your browser has blocked push notifications for
                                this site. To re-enable them, click the lock
                                icon in your browser's address bar, find
